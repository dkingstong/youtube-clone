...
const rawVideoBucketName = "dk-yt-raw-videos"
const processedVideoBucketName = "dk-yt-processed-videos"
 ...
 * @returns A promise that resolves when the video has been coverted
 */
...
function ensureDirectoryExistence(dirPath: string) {
  if(!fs.existsSync(dirPath)) {
    fs.mkdirSync(dirPath, { recursive: true }) // recursive: true enables crearting nested directories
